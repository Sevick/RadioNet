    ...
    //,ui(new Ui::MainWindow)
{
    ...
    if (Proxy!=""){
        ...
        BASS_SetConfigPtr(BASS_CONFIG_NET_PROXY,Proxy.toLatin1().data());
    }
...
void MainWindow::StartTimers(){
    ...
    BufferStatusUpdate_timer->start(300);
...
void MainWindow::setBitrateDisplay(long pBitRate){
    lNetUsageTxt->setText(QString::number(pBitRate));
}
...
bool MainWindow::InitVersion()
{
    ...
    // MsgBox(QApplication::applicationVersion(), QString(), false);
    return true;
}
